...
public class BeveragesController {
    ...
    public void addRecipe(String recipeName, String recipeDescription, Entry<String, Ingredient> headIngredient){
        Recipe addRecipe = new Recipe(recipeName,recipeDescription,headIngredient);
